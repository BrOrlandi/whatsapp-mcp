...
printf '     until then. The panel does it: under Instancias, the card\n'
printf '     that appears while the licence is missing sends an emailed link\n'
printf '     and finishes the activation after one click. Nobody opens\n'
printf '     Evolution, and rebuilds come back licensed on their own.\n'
