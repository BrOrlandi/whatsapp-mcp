...
# The panel refuses to do anything else until this password is replaced.
...
if [ -n "${ADMIN_PASSWORD}" ]; then
    ...
    printf 'The panel will ask you to replace it on first sign-in, and will do\n'
    printf 'nothing else until you do.\n\n'
else
    printf 'Password:\n  unchanged from the existing installation\n\n'
fi
...
printf 'Next:\n'
printf '  1. Sign in and set your own password.\n'
